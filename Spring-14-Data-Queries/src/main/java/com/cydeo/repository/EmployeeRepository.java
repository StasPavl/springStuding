...
public interface EmployeeRepository extends JpaRepository<Employee,Integer> {
    ...
    @Query(value = "select * from employees where first_name like %:pattern%",nativeQuery = true)
    List<Employee> retrieveAllCinemaWithPattern(@Param("pattern") String pattern);
